...
const MaintenanceAlert = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const backendUrl = 'https://solar-ai-backend-eb69.onrender.com';
            ...
            console.error(err);
            setError(`Analysis failed. Check if Backend is live at: https://solar-ai-backend-eb69.onrender.com`);
        } finally {
            setLoading(false);
        }
    };
